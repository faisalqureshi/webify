            ...
            if (not is_ignored) and is_available:
                ...
                if ipynb_settings.render_html:
                    nb_file = JupyterNotebookfile(filepath, 
                                                  ipynb_settings.execute_notebook or self.meta_data['execute_jupyter_notebook'],ipynb_settings.generate_toc or self.meta_data['generate_jupyter_toc'])
                    nb_file.load()
...
if __name__ == '__main__':
    ...
    cmdline_parser.add_argument('--generate-jupyter-toc', action='store_true',default=False, help='Generates table of contents when jupyter notebook is converted to html.  H1, H2, and H3 are used to generate the table of contents entries.')
    ...
    meta_data = {
        ...
        'execute_jupyter_notebook': cmdline_args.execute_jupyter_notebook,
        'generate_jupyter_toc': cmdline_args.generate_jupyter_toc
    }
