        ...
        for filename in dir.files['ipynb']:
            ...
            if (not is_ignored) and is_available:
                ...
                if ipynb_settings.render_html:
                    nb_file = JupyterNotebookfile(filepath, ipynb_settings.execute_notebook or self.meta_data['execute_jupyter-notebook'], self.meta_data['jupyter-toc'])
                    nb_file.load()
...
if __name__ == '__main__':
    ...
    cmdline_parser.add_argument('--jupyter-toc', action='store_true',default=False, help='Generates table of contents when jupyter notebook is converted to html.  H1, H2, and H3 are used to generate the table of contents entries.')
    ...
    meta_data = {
        ...
        'jupyter-toc': cmdline_args.jupyter_toc
    }
